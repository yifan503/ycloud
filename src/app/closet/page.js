        ...
        <>
            <div className={styles.container}>
                <div className={styles.img_container}>
                    <img src='https://cdn.yiyunjiancai.com/pages/closet/door_detail.jpg?imageslim' alt='door' className={styles.head_img} />
                ...
                <div className={styles.row}>
                    <div className={styles.img_box}>
                        <img src='https://cdn.yiyunjiancai.com/pages/closet/wardrobes2.jpg?imageslim' alt='wardrobes' className={styles.img} />
                    </div>
                </div>
                <div className={styles.row}>
                    <div className={styles.img_box}>
                        <img src='https://cdn.yiyunjiancai.com/pages/closet/wardrobes3.jpg?imageslim' alt='wardrobes' className={styles.img} />
                    </div>
                </div>
                <div className={styles.row} >
                    <div className={styles.img_box}>
                        <img src='https://cdn.yiyunjiancai.com/pages/closet/wardrobes.jpg?imageslim' alt='wardrobes' className={styles.img} />
