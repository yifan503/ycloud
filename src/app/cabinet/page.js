    ...
    return (
        <>
            <div className={styles.container}>
                ...
                <div className={styles.row}>
                    <img src='/image/cabinet3.png' alt='wardrobes' className={styles.img_gradevin} />
                    <img src='/image/cabinet4.png' alt='wardrobes' className={styles.img_gradevin} />

                </div>
                <div className={styles.row}>

                    <img src='/image/gradevin.jpg' alt='wardrobes' className={styles.img_gradevin} />
                    <img src='/image/gradevin2.jpg' alt='wardrobes' className={styles.img_gradevin} />
                </div>
                <div className={styles.intro_text_container}>
                ...
                <div className={styles.row}>
                    <img src='/image/cabinet2.png' alt='wardrobes' className={styles.img_2} />
                    <img src='/image/cabinet5.png' alt='wardrobes' className={styles.img_2} />
                </div>
